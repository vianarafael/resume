...
const headerSideBarVisible = () => {
  console.log("here");
  const node = document.querySelector(".side-header");
...
const Header = props => {
  ...
  return (
    <React.Fragment>
      <div className="header" onClick={headerSideBarVisible}>
        <div className="basic-info">
          <div className="header-name">{`氏名 ${name}`}</div>
          <div className="header-dob-gender">
            <p className="header-dob">{`生年月日 ${year} ${month} ${day}`}</p>
            <p className="header-gender">{`性別 ${gender}`}</p>
          </div>
        </div>
        <div className="photo">Da photo, yo</div>
      </div>

      <div className="side-header invisible side">
